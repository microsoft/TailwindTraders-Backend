...
$api1=$(az webapp show  -g $resourceGroup --name "$apiNamePrefix-$region1" | ConvertFrom-Json)
$api2=$(az webapp show -g $resourceGroup --name "$apiNamePrefix-$region2" | ConvertFrom-Json)
